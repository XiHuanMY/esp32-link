...
static float currentDivider_mA;
static float pwrMultiplier_mW;
static bool overflow;
static bool convAlert;
static bool limitAlert;
static int i2cAddress;
static uint16_t calVal;
static float corrFactor;
static uint16_t confRegCopy;
// TwoWire *_wire;
