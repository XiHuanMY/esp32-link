...
void TestView::Create(lv_obj_t *root)
{
    ...
    lv_obj_t *ui_PinMapIMG = lv_image_create(root);
    lv_image_set_src(ui_PinMapIMG, ResourcePool::GetImage("canbus"));
    lv_obj_align(ui_PinMapIMG, LV_ALIGN_CENTER, 0, 0);
