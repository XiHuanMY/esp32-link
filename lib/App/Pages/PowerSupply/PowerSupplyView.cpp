...
void PowerSupplyView::Create(lv_obj_t *root)
{
    ...
    lv_obj_set_x(ui_LbVoltRead, 28 - 20 + 180);
    lv_obj_set_y(ui_LbVoltRead, 70 - 20);
    ...
    lv_obj_set_x(volt_spinbox, -25 +5);
    lv_obj_set_y(volt_spinbox, -16 - 0);
    ...
    lv_obj_set_x(ui_lbtypec, 131 - 20);
    lv_obj_set_y(ui_lbtypec, 40 - 20);
    ...
    lv_obj_set_x(ui_lbvset, 270 - 20);
    lv_obj_set_y(ui_lbvset, 41 - 20);
    ...
    lv_obj_set_y(ui_lbcurrent, 110 - 20);
    ...
    lv_obj_set_x(ui_lbcset, 270 - 20);
    lv_obj_set_y(ui_lbcset, 110 - 20);
    ...
    lv_obj_set_x(ui_LbCurrentRead, 28 - 20 + 140);
    lv_obj_set_y(ui_LbCurrentRead, 131 - 10);
    ...
    lv_obj_set_x(ampe_spinbox, -65 +  44);
    lv_obj_set_y(ampe_spinbox, 70-14) ;
    ...
    lv_obj_set_x(ui_PowerButton, 61 - 20);
    lv_obj_set_y(ui_PowerButton, 176 - 20);
    ...
    lv_obj_set_x(ui_lbpowerstate, 220 - 20);
    lv_obj_set_y(ui_lbpowerstate, 177 - 20);
    ...
    lv_obj_set_y(ui_lbpower, 177 - 20);
    ...
    lv_obj_set_x(ui_LbPowerConsume, 90 - 20);
    lv_obj_set_y(ui_LbPowerConsume, 198 - 20);
    ...
    lv_obj_set_x(ui_LbVoltSet, 257 - 20);
    lv_obj_set_y(ui_LbVoltSet, 79 - 20);
    ...
    lv_obj_set_x(ui_LbCurrentSet, 267 - 20);
    lv_obj_set_y(ui_LbCurrentSet, 147 - 20);
